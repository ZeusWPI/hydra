...
public class RemoteControlClientCompat {
    ...
    public class MetadataEditorCompat {
         ...
         *
         * @param key The identifier of a the metadata field to set. Valid values are null         {@link android.media.MediaMetadataRetriever#METADATA_KEY_ALBUM},
         ...
         * {@link #apply()} has been called, will be displayed.
         *
         * @param key the identifier of a the metadata field to set. Valid values are null         {@link android.media.MediaMetadataRetriever#METADATA_KEY_CD_TRACK_NUMBER},
     ...
     *
     * @param state The current playback state, one of the following values: null     {@link android.media.RemoteControlClient#PLAYSTATE_STOPPED},
     ...
     *
     * @param transportControlFlags A combination of the following flags: null     {@link android.media.RemoteControlClient#FLAG_KEY_MEDIA_PREVIOUS},
