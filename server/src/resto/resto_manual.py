...
class ManualChange:
    ...
    def __init__(self, replacer, resto_directory, api="*", year="*", resto="*", month="*", day="*"):
        """
        ...
        self.month = month
        self.day = day
        self.resto_directory = resto_directory

    def to_glob(self):
        api2_template = Template("{}/$api/menu/$resto/$year/$month/$day".format(self.resto_directory))
        return api2_template.substitute(self.to_dict())

    def get_overview_glob(self):
        api2_template = Template("{}/$api/menu/$resto/overview.json".format(self.resto_directory))
        return api2_template.substitute(self.to_dict())
...
def restjesmaand18(resto_directory: str) -> ManualChange:
    return ManualChange(
        resto_directory=resto_directory,
        api="2.0",
        year="2018",
...
def main(resto_directory: str):
    to_apply = [
        restjesmaand18(resto_directory),
    ]
    dates = dict()
