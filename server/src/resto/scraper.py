"""
Scrape the menu from the resto.
"""
...
# Where to write to.
OUTFILE = "{}/1.0/menu/{}/{}.json"
OUTFILE_2_0 = "{}/2.0/menu/{}/{}/{}/{}.json"
OVERVIEWFILE_2_0 = "{}/2.0/menu/{}/overview.json"
...
def write_1_0(menus, output: str):
    # 1.0 is only nl.
    ...
    for weekyear, weekmenu in menus['nl'].items():
        ...
        write_json(menu, OUTFILE.format(output, year, week))


def write_2_0(menus, output: str):
    for resto, resto_menu in menus.items():
        ...
        for week_year, weekmenu in resto_menu.items():
            for day, daymenu in weekmenu.items():
                ...
                write_json(
                    menu,
                    OUTFILE_2_0.format(output, resto, day.year, day.month, day.day)
                )
        ...
        write_json(
            ...
            OVERVIEWFILE_2_0.format(output, resto)
        )


def main(output_directory: str):
    """
    :param output_directory: The output directory. This directory should exist.
    """
    all_problems = {}
    menus = {}
    for which in TYPES:
    ...
    write_1_0(menus, output_directory)
    write_2_0(menus, output_directory)
